...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=w7;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Country>(entity =>
        {
            entity.HasKey(e => e.CountryId).HasName("PK__countrie__7E8CD055689060DE");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__departme__C223242201684451");
        ...
        {
            entity.HasKey(e => e.DependentId).HasName("PK__dependen__F25E28CE2E908430");
        ...
        {
            entity.HasKey(e => e.EmployeeId).HasName("PK__employee__C52E0BA88C7F5C63");
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__jobs__6E32B6A5A7757BBA");
        ...
        {
            entity.HasKey(e => e.LocationId).HasName("PK__location__771831EA3E3ACB2A");
        ...
        {
            entity.HasKey(e => e.RegionId).HasName("PK__regions__01146BAEA370E89D");
